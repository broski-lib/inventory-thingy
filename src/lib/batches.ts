...
import { itemBatches, items } from "./schema"
...
/**
 * Fetch batches for a set of items in one query. Internal helper — not a
 * server fn. Returns a Map of itemId → batches (oldest first).
 */
